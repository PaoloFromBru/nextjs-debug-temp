  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-slate-100">
      ...
      <header className="p-6 bg-white dark:bg-slate-800 shadow">
        ...
        {/* Active cellar (mobile-first): show on its own row to avoid overflow */}
        <div className="mt-3 text-sm text-gray-700 dark:text-gray-300">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            <span className="px-2 py-1 rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-200 w-fit">
            ...
            <select
              ...
              className="p-1 border border-slate-300 dark:border-slate-600 rounded bg-white dark:bg-slate-700 w-fit"
